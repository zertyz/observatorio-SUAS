...
export class MPDadosEIndicadoresComponent implements OnInit {
  ...
  indicadoresSociais: string[][] = [
    ...
    ["Parati", "Carlos José Gama Miranda", "Valdecir Machado Ramiro", "38.740", "0,69", "2", "1", "0", "3", "0,51", "3.482", "8,99", "0,24", "2.107", "5,44", "108,05", "60,51", "R$ 4.572.123,00", "4.937", "SIM", "SIM", "SIM", "810", "R$ 757.769,67"],
